...
class ValidadorMarco{
	...
	public function __construct($titulo,$imagen,$ruta_imagen,$tipo_imagen,$tamanio_imagen,$contenido,$estado) {
        ...
        $this->error_marco = $this->validar_marco($contenido);
    ...
    public function validar_marco($contenido) {
        if (!$this->variable_iniciada($contenido)) {
            return "Debe escribir algun contenido.";
        } else {
    ...
    public function mostrar_error_imagen() {
     ...
     public function mostrar_error_marco() {
        if ($this->error_marco !== "") {
            echo $this->aviso_inicio . $this->error_marco . $this->aviso_cierre;
        }
    }
